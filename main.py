...
parser.add_argument('--load_and_tune_prompt_learner', type=str, default='False')
...
time_str = time_str + str(args.exper_name)
...
if args.dataset == "FERV39K" or args.dataset == "DFEW":
    ...
    class_names_with_context = class_names_with_context_2
    class_descriptor = class_descriptor_2
elif args.dataset == "WildDeepfake" or args.dataset == "DFDC":
    number_class = 14
    class_names = class_names_14
    class_names_with_context = class_names_with_context_14
    class_descriptor = class_descriptor_14
...
def main(set):
    ...
    if args.dataset == "FERV39K":
        ...
        log_txt_path = './log/' + 'FF++-' + time_str + '-log.txt'
        log_curve_path = './log/' + 'FF++-' + time_str + '-log.png'
        log_confusion_matrix_path = './log/' + 'FF++-' + time_str + '-cn.png'
        checkpoint_path = './checkpoint/' + 'FF++-' + time_str + '-model.pth'
        best_checkpoint_path = './checkpoint/' + 'FF++-' + time_str + '-model_best.pth'
        train_annotation_file_path = "./annotation/FF++_train.txt"
        test_annotation_file_path = "./annotation/FF++_test.txt"
    elif args.dataset == "WildDeepfake":
        print("*********** WildDeepfake Dataset ***********")
        log_txt_path = './log/' + 'WildDeepfake-' + time_str + '-log.txt'
        log_curve_path = './log/' + 'WildDeepfake-' + time_str + '-log.png'
        log_confusion_matrix_path = './log/' + 'WildDeepfake-' + time_str + '-cn.png'
        checkpoint_path = './checkpoint/' + 'WildDeepfake-' + time_str + '-model.pth'
        best_checkpoint_path = './checkpoint/' + 'WildDeepfake-' + time_str + '-model_best.pth'
        train_annotation_file_path = "./annotation/WildDeepfake_train.txt"
        test_annotation_file_path = "./annotation/WildDeepfake_test.txt"
...
def computer_uar_war(val_loader, model, best_checkpoint_path, log_confusion_matrix_path, log_txt_path, data_set):
    ...
    if args.dataset == "FERV39K":
        ...
        title_ = "Confusion Matrix on FaceForensics++ fold "+str(data_set)
    elif args.dataset == "WildDeepfake":
        title_ = "Confusion Matrix on WildDeepfake++ fold "+str(data_set)
